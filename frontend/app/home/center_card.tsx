...
const mockdata = {
  image_url: 'https://images.unsplash.com/photo-1437719417032-8595fd9e9dc6?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=600&q=80',
...
export function CenterCard ({ center }): any {
  return (
    <Card radius="md" p="md" component="a" href="/center/1" target="_blank">
      <Card.Section>
        <Image src={center.image_url} alt={center.title} height={180} />
      </Card.Section>
